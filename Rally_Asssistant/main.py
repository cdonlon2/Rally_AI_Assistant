...
def start_chat():
    while True:  
        ...
        acceptance_criteria_index = parts.index("Acceptance Criteria:")  
        acceptance_criteria = "\n".join(parts[acceptance_criteria_index + 1:]).strip()  
        
        # Print the results  
        print("Title:", title)  
        print("Description:", description)  
        print("Acceptance Criteria:", acceptance_criteria)
        create_user_story(title, description, acceptance_criteria, "U2 Commercial Analytic Engineering New Implementations")  
